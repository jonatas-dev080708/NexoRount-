...
func (p *MockProvider) Predict(ctx context.Context, messages []Message) (*Result, error) {
	return &Result{
...
func (p *MockProvider) Stream(ctx context.Context, messages []Message) (chan string, error) {
	ch := make(chan string)
